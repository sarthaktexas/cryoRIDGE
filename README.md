...
pip install "git+https://github.com/sarthaktexas/cryoem-halfmap-qc.git@v0.2.1"
```
...
**Before the manuscript is published**, cite the software with the Zenodo concept DOI (resolves to the latest release; pin `v0.2.1` or a commit hash for exact reproducibility):

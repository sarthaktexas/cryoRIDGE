...
from style.palette import PALETTES, RELIABILITY_CMAP_CC
...
STATISTIC_SPECS: dict[str, StatisticSpec] = {
    ...
    "reliability_smoothness": StatisticSpec(
        key="reliability_smoothness",
        label="Gradient energy",
        cbar_label="gradient energy (high = reliable)",
        matplotlib_cmap="viridis_r",
        chimerax_palette="viridis",
        npz_key="reliability_smoothness",
    ),
...
def _resolve_statistic_mrc(
    ...
    *,
    ...
    if spec.npz_key:
        ...
        if rel_npz.is_file() and spec.npz_key in ("reliability_score", "reliability_smoothness", "build_zone"):

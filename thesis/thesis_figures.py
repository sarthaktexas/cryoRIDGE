...
from thesis.placement_utility import QSCORE_PANEL_EXCLUDE
...
from cryoem_mrc.cohort_composition import resolve_cohort_na_residue_fraction
from cryoem_mrc.cohort_labels import cohort_figure_label, short_display_name
from cryoem_mrc.cohort_resolution import RESOLUTION_BIN_ORDER, resolution_bin_label
from cryoem_mrc.halfmap_metrics import WINDOWED_HALFMAP_CORRELATION_KEY, WINDOWED_HALFMAP_CORRELATION_LABEL
from cryoem_mrc.repo_paths import COHORT_MANIFEST, OUTPUTS_ROOT, glob_halfmap_reliability_files
...
def apply_contour_mask(
    ...
    *,
    ...
    """
    Restrict a 3D volume to the analysis contour.
...
def plot_spearman_top_bar(
    ...
    *,
    ...
    apply(ax)
    colors = [PALETTE_BLUE if v >= 0 else ZONE_OMIT for v in vals]
...
def _cohort_scatter_by_class(
    ...
    *,
    ...
    colors = cohort_class_colors(classes)
    for cls in classes:
...
def _plot_cohort_grouped_box_strip(
    ...
    *,
    ...
    colors = cohort_class_colors(groups)
